package com.expect.custom.plugins.ueditor;
...
import com.expect.custom.plugins.ueditor.define.ActionMap;
...
import com.expect.custom.plugins.ueditor.hunter.FileManager;
import com.expect.custom.plugins.ueditor.hunter.ImageHunter;
import com.expect.custom.plugins.ueditor.upload.Uploader;
...
public class ActionEnter {
	...
	public String invoke(MultipartFile upfile) throws JSONException {
		...
		case ActionMap.UPLOAD_FILE:
			...
			uploader.setActionType(actionType);
